...
MAX_LOCAL_PROFILE_SECONDS_ENV = "TEST_DATA_AGENT_MAX_LOCAL_PROFILE_SECONDS"
MAX_LOCAL_PROFILE_SAMPLE_ROWS_ENV = (
    "TEST_DATA_AGENT_MAX_LOCAL_PROFILE_SAMPLE_ROWS"
)
...
DEFAULT_MAX_LOCAL_PROFILE_SECONDS = 120.0
DEFAULT_MAX_LOCAL_PROFILE_SAMPLE_ROWS = 1_000_000
...
def max_local_profile_seconds() -> float:
    return positive_float_env(
        MAX_LOCAL_PROFILE_SECONDS_ENV,
        DEFAULT_MAX_LOCAL_PROFILE_SECONDS,
    )


def max_local_profile_sample_rows() -> int:
    return positive_int_env(
        MAX_LOCAL_PROFILE_SAMPLE_ROWS_ENV,
