...
Stable `1.5.0` is the recommended release. Read the
...
The commands below install the exact stable release.
...
Stable `1.5.0` retains the generation and validation corrections from `1.3.2`;
