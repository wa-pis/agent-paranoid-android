...
Stable release: `1.1.0` (recommended). Preview release: `1.2.0rc2` (explicit opt-in): `python3 -m pip install "agent-paranoid-android==1.2.0rc2"`. Package: `agent-paranoid-android`; CLI: `test-data-agent`.
