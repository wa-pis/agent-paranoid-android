# Tasks: pypi-trusted-publishing

- [x] Verify the PyPI project name is currently unclaimed.
- [x] Add a dedicated Trusted Publishing workflow.
- [x] Validate downloaded wheel and sdist identity before upload.
