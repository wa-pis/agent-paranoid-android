# Public Documentation Specification Delta
...
configuration snippets, and all six PostgreSQL/Trino JDBC, wildcard, and
query-source launchers through documentation contracts and installed-wheel
smoke tests.
