...
The proposed 1.6.0rc1 declared exact DECIMAL precision cap is 38 digits,
pending owner confirmation. It uses Arrow decimal128 for Parquet. This covers
DECIMAL(20,2) and DECIMAL(38,16)
