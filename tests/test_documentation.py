...
def test_readme_is_a_focused_entrypoint() -> None:
    ...
    assert PROJECT_VERSION == "1.3.2rc2"
...
def test_completed_openspec_changes_are_archived_and_baselined() -> None:
    ...
    assert active == {"_template", "openai-3-sdk-compatibility", "generation-contract-hardening"}
    ...
    assert (
        classifier_change / "specs" / "release-supply-chain" / "spec.md"
    ).is_file()
