...
"""
    ...
    legacy_rules = load_business_rules(rules_path)
    neutral_rules = load_neutral_business_rules(rules_path)

    assert ScenarioRule is NeutralScenarioRule
    assert legacy_rules == neutral_rules
